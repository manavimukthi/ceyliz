                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        href="#link"
                                        className="hover:bg-background dark:hover:border-t-border bg-muted group mx-auto flex max-w-full w-fit items-center gap-2 rounded-full border p-1 pl-3 pr-2 shadow-md shadow-black/5 transition-all duration-300 dark:border-t-white/5 dark:shadow-zinc-950 sm:gap-4 sm:pl-4">
                                        <span className="text-foreground text-xs sm:text-sm">Introducing AI-Powered Automation for Business</span>
                                    ...
                                    <h1
                                        className="mt-8 mx-auto max-w-4xl text-balance text-4xl sm:text-5xl md:text-6xl lg:mt-16 lg:text-7xl xl:text-[5.25rem]">
                                        Smart Automation Solutions for Growing Businesses
                                    </h1>
                                    <p
                                        className="mx-auto mt-6 max-w-2xl text-balance text-base sm:mt-8 sm:text-lg">
                                        Ceyliz helps small businesses eliminate repetitive tasks, close more deals, and serve customers 24/7 - powered by cutting-edge AI automation.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                        variant="ghost"
                                        className="h-10.5 w-full rounded-xl px-5 sm:w-auto">
                                        <Link href="/contact">
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                <Button
                                    ...
                                    size="sm"
                                    onClick={toggleTheme}
                                    className={cn('inline-flex shrink-0 gap-1.5 bg-background', isScrolled && 'hidden')}
