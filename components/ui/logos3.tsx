  ...
  return (
    <section className="py-12 md:py-20">
      <div className="mx-auto flex max-w-5xl flex-col items-center px-6 text-center">
        <h2 className="my-4 text-xl sm:text-2xl font-bold text-pretty md:text-4xl leading-tight">
          {heading}
        </h2>
      </div>
      <div className="pt-8 md:pt-16 lg:pt-20">
        <div className="relative mx-auto flex items-center justify-center lg:max-w-5xl px-4 sm:px-6">
          <Carousel
            opts={{ loop: true }}
          ...
          >
            <CarouselContent className="ml-0">
              {logos.map((logo) => (
                ...
                >
                  <div className="mx-3 flex shrink-0 items-center justify-center sm:mx-5 md:mx-8">
                    <div>
                      <img
                        src={logo.image}
